...
function Form() {
  ...
  return (
    <div>
          ...
          <textarea id="" cols="30" rows="10" className={`form-control mt-3 ${errors.name &&'is-invalid'}`} onChange={handleChange} name='message' value={formData.message}  placeholder='Message'></textarea>
